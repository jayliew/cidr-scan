...
declare -A CIDR_SUBNET_SIZE
CIDR_SUBNET_SIZE[24]=256
CIDR_SUBNET_SIZE[25]=128 # num of IPs per range, 
CIDR_SUBNET_SIZE[26]=64  # including broadcast and network ID
CIDR_SUBNET_SIZE[27]=32
CIDR_SUBNET_SIZE[28]=16
CIDR_SUBNET_SIZE[29]=8
CIDR_SUBNET_SIZE[30]=4

if [ $CIDR -ne 32 ] ; then
    IP_ADDRS_PER_SUBNET=${CIDR_SUBNET_SIZE[$CIDR]}
